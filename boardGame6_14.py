...
from module14.draw import field_height, field_width, draw_court, scale
        ...
        if turn in (2, 14):  # p2 打ってください
            for x, y, z, t in ballhit:
                ...
                if (
                    ...
                    ballcatchb.append((x, y, z, t))
        print("---650checkball_hit---")
        print(current_ball, p1_pos, p2_pos)
        print(len(ballhit), len(ballcatch), len(ballcatchb))
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if turn == 4:
                ...
                l1 = gt.court_l + MARGIN_LINE
                r1 = gt.court_r - MARGIN_LINE
                b1 = 1.00 + MARGIN_LINE
            ...
            message2 = (
                ...
                + "p1_pos="
                + f"{p1_pos[0]:.1f} "
                + f"{p1_pos_target[0]:.1f} "
                + f"{p1b_pos[0]:.1f} "
                + f"{p1b_pos_target[0]:.1f}"
            )
